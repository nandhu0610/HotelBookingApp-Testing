...
public class TC112 extends BaseTest {
	...
	public void TestCase112(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		double totalprice=Double.parseDouble(p9.Verify_totalprice());
		double expfinalprice=totalprice+(0.1*totalprice);
		double finalprice=Double.parseDouble(p9.Verify_finalprice());
		Assert.assertEquals(finalprice, expfinalprice, "Final price shown in BOOK A HOTEL page is wrong");
	}

...
public class TC103 extends BaseTest {
	@BeforeClass
	...
	public void TestCase103(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		p2.Submit_button();
		Assert.assertEquals(p2.verify_checkin(), "Check-In Date should not be in past", "test case failed");
	}

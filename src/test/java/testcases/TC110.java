...
public class TC110 extends BaseTest {
	...
	public void TestCase110(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		int room=Integer.parseInt(p9.Verify_roomnum());
		int night=Integer.parseInt(p9.Verify_numofdays());
		int price=Integer.parseInt(p9.Verify_pricepernight());
		int totalprice=Integer.parseInt(p9.Verify_totalprice());

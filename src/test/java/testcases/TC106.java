...
public class TC106 extends BaseTest {
	...
	public void TestCase106(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		String exp_rmnum=p8.Validate_roomnum(), room="";
		for(int i=0;i<rmno.length();i++) {
			if(rmno.charAt(i)==' ') break;
			room=room+rmno.charAt(i);
		}
		Assert.assertEquals(exp_rmnum, room, "Room number shown is wrong");
	}

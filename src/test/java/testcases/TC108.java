...
public class TC108 extends BaseTest {
	...
	public void TestCase108(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		int room=Integer.parseInt(p8.Validate_roomnum());
		int night=Integer.parseInt(p8.Validate_numofdays());
		int price=Integer.parseInt(p8.Validate_pricepernight());
		int totalprice=Integer.parseInt(p8.Validate_totalprice());
		Assert.assertEquals(totalprice, room*night*price, "Total price shown is wrong");
	}

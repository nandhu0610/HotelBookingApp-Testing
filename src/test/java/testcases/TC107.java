...
public class TC107 extends BaseTest {
	...
	public void TestCase107(String user, String pass, String loc, String htel, String rmtyp, String rmno, String adult,
		...
		String exp_rmtyp=p8.Validate_roomtype();
		Assert.assertEquals(exp_rmtyp, rmtyp, "Room type shown is wrong");
	}
